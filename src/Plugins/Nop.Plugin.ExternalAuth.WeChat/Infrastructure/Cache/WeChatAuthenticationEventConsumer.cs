...
namespace Nop.Plugin.ExternalAuth.WeChat.Infrastructure.Cache
{
    /// <summary>
    /// Facebook authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class WeChatAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(WeChatAuthenticationDefaults.ProviderSystemName))
                return;
